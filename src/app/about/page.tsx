...
export default function About() {
  ...
  return (
    <main className="relative w-full bg-[#050505] min-h-screen pt-32 pb-20 px-6 md:px-10" ref={containerRef}>
      ...
      <div className="max-w-[2000px] mx-auto z-10 relative mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div className="fade-up">
            ...
            <p className="text-xl md:text-3xl leading-relaxed text-zinc-300 font-light">
      ...
      <footer className="w-full mt-40 pt-10 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-start md:items-center gap-10 text-zinc-500 uppercase tracking-widest text-xs z-10 relative bg-[#050505]">
        <div>
